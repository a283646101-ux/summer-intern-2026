...
public class AgentController {
    ...
    public Map<String, String> chat(@RequestBody Map<String, String> request) {
        ...
        try {
            ...
            log.error("chat 接口调用大模型失败: {}", e.getMessage());
    ...
    public Map<String, String> chatGet(@RequestParam String message) {
        try {
            ...
            log.error("chatGet 接口调用大模型失败: {}", e.getMessage());
            return Map.of("error", "AI 服务暂时不可用，请稍后重试");
        }
    }
    ...
    public DecisionResponse decideIrrigation(@RequestBody(required = false) Map<String, String> request) {
        ...
        log.info("🌱 POST /api/agent/decision - sensorId={}", sensorId);
        ...
        try {
            ...
            log.error("decideIrrigation 调用大模型失败: {}", e.getMessage());
            return new DecisionResponse(
                    sensorId, 0, 0,
